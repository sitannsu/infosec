...
export function ApplicationSecurity() {
    ...
    const sections = [

        {
            ...
            subheadings: [
                {
                    title: "Perform in-depth assessments to identify complex vulnerabilities in critical systems.",
                    descriptions: [
        ...
        {
            heading: "Mobile Application Vulnerability Assessment & Penetration Testing",
            subheadings: [
                {
                    title: " Safeguard mobile apps by identifying and addressing potential exploits.",
                    descriptions: [
        ...
        {
            heading: "Web Application Vulnerability Assessment & Penetration Testing",
            subheadings: [
                {
                    title: "Protect web applications against common threats such as SQL injection and XSS attacks.",
                    descriptions: [
        ...
        },
        {
            ...
            subheadings: [
                {
                    title: "Detects vulnerabilities in your application's source code to enhance software security.",
                    descriptions: [
    ...
    return (
        <>
                    ...
                    <HeroDynamic
                        ...
                        subheading={
                            <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                Our comprehensive assessment pinpoints potential vulnerabilities before they become threats, providing a proactive defense against cyber adversaries.We understand that one size doesn’t fit all. Our tailored solutions cater to your unique business environment, ensuring that your cybersecurity strategy is as individual as your fingerprint.
                            </p>
                        }
            ...
            <CollapsibleSection
                sections={sections}
                title="Our application security services cover four key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your application security practices? "
