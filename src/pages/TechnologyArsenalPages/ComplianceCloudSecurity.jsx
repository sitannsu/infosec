...
export function ComplianceCloudSecurity() {
    ...
    const sections = [
        ...
        {
            heading: "Compliance-Focused Assessments (PCI DSS, GDPR & HIPAA)",
            subheadings: [
                {
                    title: "Address regulatory requirements with targeted evaluations.",
                    descriptions: [
        ...
        },
        {
            ...
            subheadings: [
                {
                    title: "Identify and address risks in cloud environments to ensure robust data protection.",
                    descriptions: [
    ...
    return (
        <>
                        ...
                        subheading={
                            <>
                                <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                    Our team boasts diverse expertise across PCI DSS, GDPR, and HIPAA, ensuring a comprehensive understanding of each framework.We craft personalized solutions, recognizing the unique requirements of each organization, providing precision-crafted compliance strategies.
                                </p>
                                <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-4 leading-relaxed font-heisman">
                                    We prepare your cloud for the digital tempest, simulating real-world attack vectors to test your defenses against evolving threats. Our assessments ensure your cloud remains a secure haven, even amidst the darkest cyber storms.
                                </p>
            ...
            <CollapsibleSection
                sections={sections}
                title="Our compliance & cloud security services cover two key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your compliance & cloud security practices? "
...
export default ComplianceCloudSecurity;