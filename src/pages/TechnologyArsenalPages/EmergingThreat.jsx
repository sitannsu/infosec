...
export function EmergingThreat() {
    ...
    const sections = [
        ...
        {
            heading: "Attack Surface Analysis",
            subheadings: [
                {
                    title: "Identify all possible entry points for attackers and secure them proactively.",
                    descriptions: [
        ...
        {
            heading: "IoT Security Assessment",
            subheadings: [
                {
                    title: "Safeguard IoT devices and networks against modern cyber threats.",
                    descriptions: [
        ...
        },
        {
            ...
            subheadings: [
                {
                    title: "Visualize and mitigate potential threats to critical systems and applications.",
                    descriptions: [
    ...
    return (
        <>
                    ...
                    <HeroDynamic
                        ...
                        subheading={
                            <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                The digital landscape shimmers with opportunity, but beneath its inviting surface lurks a constant shadow: the threat of attack. Hackers, like digital specters, probe and prod, searching for the chink in your armor, the vulnerability that could bring your world crashing down. Utilize AZ Infosec’s Threat Modeling: tactical intelligence unit, shedding light on potential vulnerabilities before they become exploited.
                            </p>
                        }
            ...
            <CollapsibleSection
                sections={sections}
                title="Our emerging threat services cover three key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your emerging threat practices? "
