...
export function OperationalSecurity() {
    ...
    const sections = [

        {
            ...
            subheadings: [
                {
                    title: " Integrate security into your development pipeline to prevent issues early in the software lifecycle.",
                    descriptions: [
        ...
        {
            heading: "Configuration Management & Hardening",
            subheadings: [
                {
                    title: "Ensure all configurations comply with best practices to minimize risks.",
                    descriptions: [
        ...
        },
        {
            ...
            subheadings: [
                {
                    title: "Practical steps and expert advice to resolve discovered vulnerabilities efficiently.",
                    descriptions: [
    ...
    return (
        <>
                    ...
                    <HeroDynamic
                        ...
                        subheading={
                            <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                We move security left, making it an inseparable partner in every development stage. Integrated threat modeling, automated security tooling, and continuous code reviews become part of the development rhythm, identifying and eliminating vulnerabilities before they can disrupt performance.
                            </p>
                        }
            ...
            <CollapsibleSection
                sections={sections}
                title="Our Operational security services cover three key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your operational security practices? "
