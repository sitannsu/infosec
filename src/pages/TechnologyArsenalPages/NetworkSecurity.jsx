...
export function NetworkSecurity() {
    ...
    const sections = [

        {
            ...
            subheadings: [
                {
                    title: "Evaluate the design and layout of your network to identify vulnerabilities and optimize performance",
                    descriptions: [
                        " ",
        ...
        {
            heading: "Network Vulnerability Assessment & Penetration Testing",
            subheadings: [
                {
                    title: "Uncover weak points in your network infrastructure and simulate real-world attacks to strengthen defenses.",
                    descriptions: [
        ...
        {
            heading: "Wireless Security Assessment",
            subheadings: [
                {
                    title: "Ensure secure wireless network operations and mitigate risks of unauthorized access.",
                    descriptions: [
    ...
    return (
        <>
                    ...
                    <HeroDynamic
                        ...
                        subheading={
                            <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                AZ Infosec takes a hands-on approach to network security testing. Through penetration testing, we simulate real-world cyberattacks to identify weak links and fortify your defenses against potential breaches.
                            </p>
                        }
            ...
            <CollapsibleSection
                sections={sections}
                title="Our Network Security services cover three key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your network security practices? "
