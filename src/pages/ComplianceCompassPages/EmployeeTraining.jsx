...
export function EmployeeTraining() {
    ...
    const sections = [
        ...
        {
            heading: "Security Training Programs",
            subheadings: [
                {
                    title: " Educate and empower your team with ongoing training to improve security awareness and resilience.",
                    descriptions: [
                        " ",
    ...
    return (
        <>
            ...
            <CollapsibleSection
                sections={sections}
                title="Our employee training & awareness services cover this key area:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your employee training & awareness practices? "
