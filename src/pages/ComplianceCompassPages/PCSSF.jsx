...
function PCSSF() {
    const descriptionItems = [
        "Breaches happen. Be prepared. Achieve secure payment processing and compliance with Ampcus Cyber’s PCI SSF expertise. Our tailored approach ensures comprehensive compliance solution with industry regulations. With a focus on training, scoping, assessing, mitigating, and auditing, we guide organizations through the complexities of PCI SSF requirements."
    ];
    ...
    return (
        <>
            <SubPageHero
                title="Get PCI SSF Compliance and Secure Your Card Data"
            ...
            <HeroSection
                title="Strengthen Your Security: PCI SSF Service"
                subtitle=""
                description1="In the ever-evolving landscape of cybersecurity, Ampcus Cyber introduces its PCI Secure Software Framework (SSF) Service, a comprehensive solution designed to fortify businesses by ensuring secure development practices, robust software protection, and adherence to PCI Software Security Framework requirements"
                description2=""
