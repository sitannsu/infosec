...
function ISMS() {
    const descriptionItems = [
        "Ampcus Cyber empowers businesses to achieve and maintain ISO/IEC 27001 certification effortlessly."
    ];
    ...
    return (
        <>
            <SubPageHero
                ...
                subtitle="Get ISO 27001 and IEC 27001 Compliance Certification"
            ...
            <HeroSection
                title="Fortify Your Information Security: ISMS – ISO/IEC 27001 Certification"
                subtitle=""
                description1="In an era where information is a critical asset, Ampcus Cyber introduces its Information Security Management System (ISMS), an ISO/IEC 27001 certification service. Elevate your organization’s commitment to information security with a globally recognized certification that signifies robust data protection measures.."
                description2=""
