...
export function PrivacyCompliance() {
    ...
    const sections = [
        ...
        {
            heading: "PIMS - ISO/IEC 27701 Compliance",
            subheadings: [
                {
                    title: "Our team guides you through achieving ISO/IEC 27701 certification, an international standard for managing and protecting personally identifiable information (PII). This service includes:",
                    descriptions: [
        ...
        {
            heading: "DPDP Act Compliance",
            subheadings: [
                {
                    title: "Ensure Compliance with India’s Data Protection Law for businesses operating in or with India, compliance with the Digital Personal Data Protection (DPDP) Act is crucial. AZ Infosec helps ensure compliance with India’s unique data protection requirements, including:",
                    descriptions: [
                        "Data Handling & Privacy Policy Updates: Adapt your policies and practices to align with the DPDP Act.",
                        "Data Subject Rights: Implement measures to facilitate user rights, such as access, rectification, and deletion",
                        "Regular Compliance Audits: Ongoing assessments to keep your organization compliant.",
        ...
        },
        {
            ...
            subheadings: [
                {
                    title: "Protect Data and Meet EU Standards for businesses handling EU resident data, GDPR compliance is non-negotiable. AZ Infosec offers full GDPR compliance services, including:",
                    descriptions: [
                        "Data Mapping & Processing Records: Track and document data flows in line with GDPR.",
                        "Risk Assessment & Data Protection Impact Assessments (DPIA): Identify potential risks and implement safeguards.",
                        "Data Breach Management: Establish protocols to manage and report data breaches within required timelines",
    ...
    return (
        <>
            ...
            <CollapsibleSection
                sections={sections}
                title="Our privacy compliance services cover three key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your data privacy practices? "
