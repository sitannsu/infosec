...
export function ManagedLegal() {
    ...
    const sections = [

        {
            ...
            subheadings: [
                {
                    title: "Comprehensive security monitoring and response services tailored to your needs.",
                    descriptions: [
        ...
        {
            heading: "Cyber Attorney as a Service",
            subheadings: [
                {
                    title: "Access to legal expertise in cybersecurity, ensuring compliance with regulatory requirements and risk mitigation.",
                    descriptions: [
    ...
    return (
        <>
                    ...
                    <HeroDynamic
                        ...
                        subheading={
                            <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                Let us help to build and manage the security team for your organization and achieve your security goals.
                            </p>
                        }
            ...
            <CollapsibleSection
                sections={sections}
                title="Our managed security & legal support services cover two key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your managed security & legal support practices? "
