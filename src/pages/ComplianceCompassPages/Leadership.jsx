...
export function Leadership() {
    ...
    const sections = [
        ...
        {
            heading: "Virtual/Shared CISO as a Service",
            subheadings: [
                {
                    title: "Access to an experienced Chief Information Security Officer to guide strategy, compliance, and risk management.",
                    descriptions: [
                        " ",
        ...
        },
        {
            ...
            subheadings: [
                {
                    title: " A dedicated Data Protection Officer to manage data privacy compliance and protect sensitive information.",
                    descriptions: [
    ...
    return (
        <>
                    ...
                    <HeroDynamic
                        ...
                        subheading={
                            <p className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 sm:mt-4 md:mt-6 leading-relaxed font-heisman">
                                Is governing cyber security a challenge for your organization? We can take your worries away and our seasonal leaders can lead it for you and make sure that you always meet the compliance requirements.
                            </p>
                        }
            ...
            <CollapsibleSection
                sections={sections}
                title="Our  leadership & compliance services cover two key areas:"
                heading=""
                subheading=""
            />
            ...
            <GetStarted
                image={image1}
                header="Ready to strengthen your  leadership & compliance practices? "
