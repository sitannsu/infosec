...
export function BusinessContinuity() {
    ...
    const tabs = [
        {
            label: "Proven Expertise in Continuity Planning: ",
            content:
                "Experience designing and implementing BCMS for diverse industries.",
        },
        {
            label: "Comprehensive Support:  ",
            content:
                "From risk assessments to recovery planning, we’re with you at every step.",
        },
        {
            label: "Enhanced Operational Resilience:  ",
            content:
                "Minimize operational disruptions and maintain client trust, even in challenging times.",
        },
        {
    ...
    const securityTabsData = [
        { label: 'Identify Critical Processes', content: 'Pinpoint key operations that need to continue during a disruption' },
        { label: 'Develop Recovery Strategies: ', content: 'Create actionable plans to restore business functions and mitigate risk.' },
        { label: 'Implement Testing & Training: ', content: 'Prepare your team with regular drills and exercises to ensure readiness.' },
        { label: 'Certification Support:  ', content: 'Assistance in preparing for ISO/IEC 22301 audits and certification to validate your continuity measures.' },


    ];

    const complianceSolutions1 = [
        { label: "BCMS- ISO/IEC 22301", path: "/pcdss" },
    ...
    const tabitems = [
        {
            label: "Identify Critical Processes",
            content: [
                {
        ...
        {
            label: "Develop Recovery Strategies",
            content: [
                {
                    title: "Threat Mitigation",
                    items: ["Regular system updates", "Employee training", "Incident response plans"],
                },
                {
                    title: "Security Frameworks",
                    items: ["ISO 27001", "NIST Cybersecurity Framework", "Zero Trust Architecture"],
                },
                {
                    title: "Threat Mitigation",
                    items: ["Regular system updates", "Employee training", "Incident response plans"],
        ...
        // New Tab: Data Management
        {
            ...
            content: [
                ...
                },
                {
                    ...
                    items: [
                        "Archival for 7 years",
                        "Regular audits for unused data",
    ...
    const itemstab = [
        {
            image: insurance,
            title: "Proven Expertise in Continuity Planning",
            description:
                "Experience designing and implementing BCMS for diverse industries.",
        },
        {
        ...
        {
            image: vendor,
            title: "Enhanced Operational Resilience",
            description:
                "Minimize operational disruptions and maintain client trust, even in challenging times.",
        },
    ];
    ...
    const sections = [

        {
            ...
            subheadings: [
                {
                    title: "Ensure Business Resilience with ISO/IEC 22301 Certification.",
                    descriptions: [
                        "Achieving ISO/IEC 22301 certification demonstrates your organization’s commitment to maintaining business continuity under any circumstance. AZ Infosec offers end-to-end support in building a robust BCMS that aligns with ISO/IEC 22301 standards, helping you:",
                        "Identify Critical Processes: Pinpoint key operations that need to continue during a disruption.",
                        "Develop Recovery Strategies: Create actionable plans to restore business functions and mitigate risk.",
                        "Implement Testing & Training: Prepare your team with regular drills and exercises to ensure readiness.",
                        "Certification Support: Assistance in preparing for ISO/IEC 22301 audits and certification to validate your continuity measures.",
    ...
    return (
        <>
            ...
            <CollapsibleSection
                sections={sections}
                title="Our business continuity & disaster practices cover this key area:"
                heading=""
                subheading=""
            />
            ...
            <WhyChooseAZInfosec
                title="Why Choose AZ Infosec For BCMS?"
                items={itemstab}
            />
            ...
            <GetStarted
                image={image1}
                header="Build a resilient future for your business."
                description="Contact us today to explore how our Business Continuity and Disaster Recovery services can safeguard your operations."
